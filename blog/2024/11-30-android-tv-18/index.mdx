...
are supported: intro, outro, preview, recap and commercial with two actions to choose from:
...
Together with these loading changes, we now also reliably support Presentation Graphic Stream (PGS) subtitles and positioning tags in the
...
We currently support 2 types of lyrics: timed lyrics, which will highlight the current line of the vocal track, and untimed lyrics, which
will automatically scroll based on the track duration.
...
We've also added two experimental options for playback. The first related to decoding audio codecs, while normally the app will
...
We'd also like to thank everyone who contributed translations, reported bugs, provided feedback and participated in beta testing!
